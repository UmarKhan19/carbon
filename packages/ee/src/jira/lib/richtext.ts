/**
 * Utilities for bidirectional conversion between Markdown (JIRA description format)
 * and Tiptap JSON (Carbon's rich text format).
 *
 * JIRA's API uses plain markdown for the `description` field.
 ...
 * This is used when syncing from JIRA → Carbon.
 */
 ...
 * This is used when syncing from Carbon → JIRA.
 */
