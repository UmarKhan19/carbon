...
export const rfqExtractionSchema = z.object({
  ...
  purchasingContactName: confidenceField(z.string()).optional(),
  purchasingContactEmail: confidenceField(z.string()).optional(),
  purchasingContactPhone: confidenceField(z.string()).optional(),
  engineeringContactName: confidenceField(z.string()).optional(),
  engineeringContactEmail: confidenceField(z.string()).optional(),
  engineeringContactPhone: confidenceField(z.string()).optional(),
  customerAddressLine1: confidenceField(z.string()).optional(),
  customerAddressLine2: confidenceField(z.string()).optional(),
  customerCity: confidenceField(z.string()).optional(),
  customerStateProvince: confidenceField(z.string()).optional(),
  customerPostalCode: confidenceField(z.string()).optional(),
  customerCountry: confidenceField(z.string()).optional(),
