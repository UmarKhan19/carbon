-- Business Rules refactor — enum additions only.
...
ALTER TYPE "transactionSurface" ADD VALUE IF NOT EXISTS 'putaway';
...
-- New enum identifying which entity a businessRule applies to.
CREATE TYPE "businessRuleTargetType" AS ENUM ('item', 'storageUnit', 'workCenter');
