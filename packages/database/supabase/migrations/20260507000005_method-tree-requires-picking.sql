-- ============================================================
-- get_method_tree: include methodMaterial.requiresPicking so the
-- BoM-explosion path in get-method/index.ts can propagate the flag
-- into jobMaterial.requiresPicking. Without this, line-side BoM
