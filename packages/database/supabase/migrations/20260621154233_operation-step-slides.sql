...
CREATE TABLE "methodOperationStepSlide" (
...
CREATE INDEX "methodOperationStepSlide_stepId_idx" ON "methodOperationStepSlide" ("stepId");
CREATE INDEX "methodOperationStepSlide_companyId_idx" ON "methodOperationStepSlide" ("companyId");

-- 2. Job slides (copied from the template by get-method)
CREATE TABLE "jobOperationStepSlide" (
  "id" TEXT NOT NULL DEFAULT id('slide'),
  "stepId" TEXT NOT NULL,
  "imagePath" TEXT NOT NULL,
  "caption" TEXT,
...
CREATE INDEX "jobOperationStepSlide_stepId_idx" ON "jobOperationStepSlide" ("stepId");
CREATE INDEX "jobOperationStepSlide_companyId_idx" ON "jobOperationStepSlide" ("companyId");

-- 3. Quote slides (copied from the template by get-method)
CREATE TABLE "quoteOperationStepSlide" (
  "id" TEXT NOT NULL DEFAULT id('slide'),
  "stepId" TEXT NOT NULL,
  "imagePath" TEXT NOT NULL,
  "caption" TEXT,
...
CREATE INDEX "quoteOperationStepSlide_stepId_idx" ON "quoteOperationStepSlide" ("stepId");
CREATE INDEX "quoteOperationStepSlide_companyId_idx" ON "quoteOperationStepSlide" ("companyId");
