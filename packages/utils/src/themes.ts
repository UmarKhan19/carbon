...
export const themes = [
...

  {
    ...
    cssVars: {
      light: {
        background: "0 0% 100%",
        foreground: "160 16% 3.9%",
        card: "0 0% 100%",
        "card-foreground": "160 16% 3.9%",
        popover: "0 0% 100%",
        "popover-foreground": "160 16% 3.9%",
        primary: "160 92% 33%",
        "primary-foreground": "160 100% 97.3%",
        active: "160 0% 96%",
        "active-foreground": "0 0% 4.1%",
      ...
      dark: {
        ...
        foreground: "0 0% 95%",
        popover: "160 0% 9%",
        "popover-foreground": "160 0% 95%",
        card: "160 0% 9%",
        "card-foreground": "160 0% 95%",
        primary: "160 92% 44%",
        "primary-foreground": "160 80.4% 10%",
        active: "160 18% 15%",
        "active-foreground": "160 92% 44%",
