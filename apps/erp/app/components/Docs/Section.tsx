...
// A documentation section: a figure/label eyebrow, an optional heading, and a
// hairline wipe + reveal animation as it scrolls into view. Shared by the MCP
// docs and the user guide.
