...
import { deletePricingRule, getPricingRule } from "~/modules/sales/pricing";
...
export default function DeletePricingRuleRoute() {
  ...
  return (
    <ConfirmDelete
      ...
      text={`Are you sure you want to delete the pricing rule: ${pricingRule.name}? This cannot be undone.`}
