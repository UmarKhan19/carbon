...
- accounting_* — 33 read, 19 write, 6 delete tools
...
- people_* — 25 read, 14 write, 6 delete tools
- production_* — 62 read, 45 write, 22 delete tools
- purchasing_* — 52 read, 35 write, 11 delete tools
- quality_* — 38 read, 19 write, 11 delete tools
- resources_* — 47 read, 27 write, 20 delete tools
- sales_* — 79 read, 55 write, 18 delete tools
- settings_* — 28 read, 41 write, 3 delete tools
