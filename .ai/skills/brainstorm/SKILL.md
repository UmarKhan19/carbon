...
Save to `.ai/research/[feature-slug].md`.
...
Save to `.ai/research/[feature-name]-design.md`:
...
| Artifact | Location |
|----------|----------|
| Competitor research | `.ai/research/[feature-slug].md` |
| Design specification | `.ai/research/[feature-name]-design.md` |
